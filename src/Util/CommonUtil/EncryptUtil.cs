...
namespace CommonUtil
{
    ...
    public class EncryptUtil
    {
        ...
        //因此加多一层目录.
        static string rootFile = Path.Combine(rootPath, "xFusion\\SCCM Plugin For FusionDirector\\base.kn");
        static string mainFile = Path.Combine(rootPath, "xFusion\\SCCM Plugin For FusionDirector\\main\\main.kn");
        /// <summary>
        /// 获得根密钥
        /// </summary>
        /// <returns>根密钥</returns>
        ...
        #region 兼容旧的密钥
        static string versionFile = Path.Combine(rootPath, "xFusion\\SCCM Plugin For FusionDirector\\vrn.kn");
