var i18n_en = {
    ...
    config: {
        ...
        configurationModule_submitErrorRaidNamePatternLabel: "The value contains a maximum of 15 characters, including letters, digits, spaces, and special characters `~!@#$%^&*()=+\\|\[{}\];:'\",<.>/?.",
    ...
    imageManage: {
        ...
        imageManage_imageTypeColon: "Image Type",
        imageManage_imageVersionColon: "Image Version",
        imageManage_serverType: "Server Type",
    ...
    upgradePackageWarehouse: {
        ...
        versionWarehouse_xfusionBaseline: "XFUSION baseline",
        ...
        versionWarehouse_downLoadTip: "Upload the update package and digital signature certificate to this system. The size of each uploaded file must be less than 10 GB.",
        ...
        versionWarehouse_leastVersio: "Latest XFUSION baseline",
        versionWarehouse_xfusionOfficiallyReleases: "Latest baseline version on houp.xfusion.com",
        ...
        versionWarehouse_networkUnknownFailedMethodFour: "If the fault persists, contact XFUSION engineers.",
        ...
        versionWarehouse_networkTargetURLFailedMethod: "Check whether the current website is the specified website for XFUSION firmware update.",
    ...
    deviceVersionStatus: {
        ...
        deviceVersionStatus_UnableToObtainTip: "The OS version can be displayed only after iBMA 2.0 and above have been installed and started.",
        ...
        deviceVersionStatus_hostName: "iBMC Hostname",
    ...
    upgradePlan: {
        ...
        upgradePlan_xfusionBaseline: "XFUSION baseline",
        ...
        upgradePlan_diskRelationRaidNotMatch: "The update package does not match the RAID card model of the hard disk and cannot be updated.",
        upgradePlan_lowVersion: "The target version is earlier than the source version. Update is not recommended.",
