var errorCode_zh_CN = {
    ...
    "os.20004": 'OS部署失败',
    /***************************FD Start**********************************/
    'UnkownMessageId': '未知错误，请联系超聚变管理员',
    ...
    "FusionDirector.1.0.LicenseESNMismatch": {
        ...
        "NumberOfArgs": 0,
        "Resolution": "请导入与系统ESN匹配的许可证。如果申请许可证的ESN填写错误，请在ESDP平台变更许可证的ESN或联系超聚变技术支持工程师。"
    },
    ...
    "FusionDirector.1.0.LicenseExpired": {
        "Message": "许可证激活时间已过期。",
        "NumberOfArgs": 0,
        "Resolution": "请联系超聚变技术支持工程师，获取新的许可证进行激活。"
    },
    "FusionDirector.1.0.LicenseInvalidFile": {
        "Message": "许可证已失效。",
        "NumberOfArgs": 0,
        "Resolution": "请在ESDP平台激活许可证或联系超聚变技术支持工程师。"
    },
    "FusionDirector.1.0.LicenseVersionMismatch": {
        "Message": "许可证版本不匹配",
        "NumberOfArgs": 0,
        "Resolution": "请导入与系统版本匹配的许可证，如果没有版本匹配的许可证，请联系超聚变技术支持工程师。"
    },
...
var errorCode_en = {
    ...
    "FusionDirector.1.0.LicenseESNMismatch": {
        ...
        "NumberOfArgs": 0,
        "Resolution": "Import a license file that matches the system ESN. If the ESN used to apply for the license file is incorrect, change the ESN of the license file on the ESDP or contact XFUSION technical support."
    },
    "FusionDirector.1.0.LicenseVerifyFailed": {
    ...
    "FusionDirector.1.0.LicenseExpired": {
        ...
        "NumberOfArgs": 0,
        "Resolution": "Contact XFUSION technical support to obtain a new license file and activate it."
    },
    "FusionDirector.1.0.LicenseInvalidFile": {
        "Message": "The license file has expired.",
        "NumberOfArgs": 0,
        "Resolution": "Activate the license file on the ESDP or contact XFUSION technical support."
    },
    "FusionDirector.1.0.LicenseVersionMismatch": {
        "Message": "The license file version does not match.",
        "NumberOfArgs": 0,
        "Resolution": "Import a license file that matches the system version. If the license file does not match the system version, contact XFUSION technical support."
    },
    "FusionDirector.1.0.DeployModelChangeError": {
